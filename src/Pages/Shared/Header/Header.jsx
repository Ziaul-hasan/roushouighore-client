        ...
        <div>
            <div className='flex justify-between items-center p-4 md:px-20 md:py-3 relative z-20 bg-black bg-opacity-25'>
                ...
                <div>
                    ...
                    <ul className={`md:inline-flex absolute md:static duration-100 ${open ? 'top-20 left-0 right-0 ps-10' : '-top-56 left-0 right-0 ps-10'} space-y-3 md:space-y-0 md:space-x-8 py-4 text-white text-xl md:bg-transparent bg-black bg-opacity-25`}>
